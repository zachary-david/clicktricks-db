  ...
  const competitors = [
    {
      name: "HubSpot",
      price: "$540+/year",
      features: ["Complex setup", "$45/month = $540/year", "90% features unused"]
    },
    {
      name: "Salesforce",
      price: "$1,800+/year",
      features: ["Enterprise complexity", "Hidden costs everywhere", "Not for small teams"]
    }
  ];
      ...
      <div className="container">
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 bg-green-100 text-green-800 px-6 py-3 rounded-full">
            ...
            <span className="font-medium">30-Day Support Guarantee</span>
          </div>
          <p className="text-gray-600 mt-4">
            Get 30 days of dedicated support to ensure you're using your new CRM system effectively.
          </p>
        </div>
      </div>
    </section>
