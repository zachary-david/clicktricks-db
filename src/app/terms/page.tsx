    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center space-x-2">
              <div className="text-2xl font-bold">
                <span style={{ color: '#01a2f1' }}>ClickTricks</span>{' '}
                <span style={{ color: '#0182c4' }}>DB</span>
              </div>
            </Link>
            <Link 
              href="/" 
              className="text-gray-600 hover:text-[#01a2f1] transition-colors duration-200"
            >
              Back to Home
            </Link>
          </div>
      ...
      <main className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">1. Service Description</h2>
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">3. Service Limitations and Scope</h2>
          <p className="mb-4 text-gray-700">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">4. Client Responsibilities</h2>
          <p className="mb-4 text-gray-700">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">6. Support and Guarantee</h2>
          <p className="mb-4 text-gray-700">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">8. Cancellation and Refunds</h2>
          <p className="mb-6 text-gray-700">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">9. Privacy and Data Protection</h2>
          <p className="mb-6 text-gray-700">
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-6">
            <p className="text-gray-700 mb-2">
              <strong>Email:</strong> legal@clicktricksdb.com
            </p>
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="text-center">
            ...
            <div className="mt-4 space-x-4">
              <Link href="/privacy" className="text-[#01a2f1] hover:text-[#0182c4] text-sm">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-[#01a2f1] hover:text-[#0182c4] text-sm">
                Terms of Service
              </Link>
            </div>
          </div>
